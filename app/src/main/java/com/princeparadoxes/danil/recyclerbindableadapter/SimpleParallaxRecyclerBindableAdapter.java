 ...
 */
public class SimpleParallaxRecyclerBindableAdapter<T, VH extends BindableViewHolder>
        extends ParallaxRecyclerBindableAdapter<T, VH> {
    ...
    public SimpleParallaxRecyclerBindableAdapter(int layoutId, Class<VH> vhClass) {
