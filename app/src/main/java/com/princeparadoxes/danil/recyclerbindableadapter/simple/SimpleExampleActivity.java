...
import com.princeparadoxes.danil.recyclerbindableadapter.SimpleRecyclerBindableAdapter;
...
public class SimpleExampleActivity extends AppCompatActivity implements SimpleViewHolder.SimpleActionListener {
    ...
    private SimpleRecyclerBindableAdapter<Integer, SimpleViewHolder> simpleExampleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleExampleAdapter = new SimpleRecyclerBindableAdapter<>(
