...
public abstract class ParallaxBindableAdapter<T, VH extends RecyclerView.ViewHolder>
    ...
    private HeaderFooterContainer header;
    private HeaderFooterContainer footer;
    ...
    private void translateView(float of, HeaderFooterContainer view, boolean isFooter) {
    ...
    public VH onCreateViewHolder(ViewGroup viewGroup, int type) {
        ...
        if (type != TYPE_HEADER && type != TYPE_FOOTER) {
            ...
            header = new HeaderFooterContainer(viewGroup.getContext(), isParallaxHeader, false);
            ...
            //create a new ParallaxContainer
            footer = new HeaderFooterContainer(viewGroup.getContext(), isParallaxFooter, true);
            //make sure it fills the space
